...
この作業を左右キースイッチ基板で各25回、合計50回行います。
...
画像のように、左右トッププレートへM2x7mmスペーサーを、M2x8mmねじで取り付けます。

左右トッププレートで取り付け向きが異なるので注意して下さい。
...
キースイッチ基板からキースイッチが浮かないようにはんだ付けします。
...
トッププレートの形状の関係上、一部のキースイッチが他と比べてキースイッチ基板から浮きやすいので、

四隅のキースイッチと同じように一つずつはんだ付けします。

# LEDテープのはんだ付け

LEDテープ裏面のシールをはがします。

その後、画像の向きに左右キースイッチ基板へLEDテープを貼り付けます。
...
# ProMicro基板のトッププレートへのねじ止め
画像を参考に、ProMicro基板をトッププレートへねじ止めします。

(画像。ねじ止め個所と、ねじ、スペーサー、ナットの位置関係がわかるように。)
