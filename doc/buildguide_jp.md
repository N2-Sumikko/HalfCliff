...
キースイッチとジャンパピンが干渉する部分がある場合は切り落とす
...
ProMicro基板を固定するねじについては、M2のナットを空転しないように押さえながら本締めしてください。
...
一番下の列に使用する1uのキーキャップが足りない場合、
ファンクションキー用のキーキャップを逆向きにして取り付けて代用するとよいです。
