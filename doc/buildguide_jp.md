...
正しく取り付けが行えたら、四隅のいずれかのキースイッチの2つのピンのうち1つをはんだ付けします。

その後、キースイッチがキースイッチ基板から浮いていないことを確認します。浮いている場合は修正します。

確認後、残りのピンをはんだ付けします。

同様の作業を、残り3つのキースイッチに対して行います。

# 残りのキースイッチの取り付け、はんだ付け

キースイッチの取り付け、はんだ付けを残りのキースイッチに対して行います。

一部のキースイッチは、固定が他のキースイッチと比べてトッププレートへの固定が甘くなるので、

キースイッチ基板から浮かないように注意します。

# M2x7mmスペーサー4つの取り付け
キースイッチ基板へM2x7㎜スペーサー4つを取り付けます。

# スペーサーのトッププレートへのねじ止め
M2x7mmスペーサーとトッププレートをM2x4mmねじでねじ止めします。
