...
左ボトムプレート|	1	|	アクリル製の透明な板のうち、一番大きいものです。
右ボトムプレート|	1	|	アクリル製の透明な板のうち、二番目に大きいものです。
...
左拡張基板(JIS)用トッププレート	|	1	|	四角形の穴が開いた白色の基板のうち、一番小さいものです。
右拡張基板(JIS)用トッププレート	|	1	|	四角形の穴が開いた白色の基板のうち、二番目に大きいものです。
...
# 1x4ピンソケット(ロープロファイル)のはんだ付け
1x4ピンソケット(ロープロファイル)を取り付け、はんだ付けします。
