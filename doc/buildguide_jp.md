...
基本セット(左右ProMicro基板＋左右キースイッチ基板＋左右JIS拡張基板）の組立方法が記載されています。
...
|名前|合計数|備考|
|:-|:-|:-|
ProMicro基板|2|表にControl Boardと書いてある基板です。他の基板と繋がっている事もあります。
1x9L字ピンソケット|4|黒色のピンがL字型の９ピンのピンソケットです。樹脂部分の長さは8.5㎜です。
1x12ピンソケット|4|黒色の12ピンのピンソケットです。樹脂部分の長さは5.7㎜です。
リセットスイッチ|2|ボタンがある四角い部品です。
2x4細ピンヘッダ(2mmピッチ)|2|2x4ピンのピンヘッダです。
...
1x4ロープロファイルピンソケット|2|4ピンの背が低いピンソケットです。(拡張用)
...
|名前|合計数|備考|
|:-|:-|:-|
左JIS拡張基板|1|表にLeft Extension Boardと書いてある基板です。他の基板と繋がっている事もあります。
...
画像は右端の5個だけダイオードをはんだ付けし、リードをカットした時のものです。
...
おおまかな流れは以下の通りです。
* (左JIS拡張基板とProMicro基板が繋がっている場合)ProMicro基板と繋がっていた部分の整形、やすりがけ
* ダイオードのはんだ付け
* 1x8(右は1x9)ロープロファイルピンヘッダのはんだ付け
* (右のみ)スタビライザーの取付け
