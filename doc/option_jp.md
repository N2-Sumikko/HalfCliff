...
## 使用時の主な注意点
* OLEDによっては、基板とディスプレイの間に厚い両面テープがあり、全体の厚みが増していることがあります。そのような場合、中空スペーサーを使用してもOLEDとProMicroカバーが干渉する可能性があります。対策としては、ディスプレイを割らないように気を付けながら両面テープをはがし、薄い両面テープを貼り直すと良いです。
