...
## 使用時の主な注意点
* OLEDによっては、OLEDの基板とディスプレイの間に厚い両面テープがあり、全体の厚みが増している場合があります。そのような場合、中空スペーサーを使用してもOLEDとProMicroカバー等が干渉する可能性があります。そのような場合、ディスプレイを割らないように気を付けながら両面テープをはがし、薄い両面テープで貼り付け直すと良いです。
