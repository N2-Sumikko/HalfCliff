...
実際に対応を確認しているロータリーエンコーダは以下の通りです。
...
* β版にてロータリーエンコーダを後付けする場合は、端子の位置や角度をトッププレートと干渉しないよう調整するか、トッププレートの干渉部分を削る必要があります。
* ロータリーエンコーダを使用する場合、対応するファームウェアの書込みが必要です。
* ロータリーエンコーダ操作時の動作を変更する場合、ファームウェアをコンパイルできる環境が必要です。
...
|トラックボールモジュール取付用キット|1個|トラックボールモジュール固定用基板、ねじ、スペーサ、ピンヘッダ1x4等が同梱されたキットです。|
...
* トラックボールを使用する場合、ファームウェアの変更が必要です。
