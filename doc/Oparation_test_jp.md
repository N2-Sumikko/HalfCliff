...
クリック後、表示されたダイアログにて、画像の赤枠で囲んだ部分(フォルダのパス。フォルダの場所を示すもの）をコピーしておきます。
...
```
qmk setup --home コピーした部分>/qmk_firmware
```
...
QMK MSYSを使用して動作テストを行う場合、例えばshiftキー等は入力したかどうかわからないかと思います。
